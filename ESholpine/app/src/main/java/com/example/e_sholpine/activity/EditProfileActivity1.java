...
public class EditProfileActivity1 extends Activity implements View.OnClickListener {
...
// ((GlobalVariable) this.getApplication()).setAvatarUri(data.getData());
    ...
    private void uploadAvatar() {
        ...
        ProgressDialog progress = new ProgressDialog(EditProfileActivity1.this);
        ...
        upload.putFile(avatarUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(EditProfileActivity1.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EditProfileActivity1.this, "Image Failed", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void moveToEdit(String mode, String content) {
        Intent intent = new Intent(this, EditActivity1.class);
