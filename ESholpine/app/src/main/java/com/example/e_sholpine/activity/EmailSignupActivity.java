...
import com.example.e_sholpine.model.Profile;
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           // Toast.makeText(getApplicationContext(),firebaseUser.getPhoneNumber()+"Phone Number",Toast.LENGTH_SHORT).show();
                            ...
                            moveToAnotherActivity(com.example.e_sholpine.activity.HomeScreenActivity.class);
        ...
        db.collection("users")
                ...
                .get().addOnCompleteListener(task -> {
                    ...
                    if (msg.equals("FALSE")) {
                        ...
                        moveToAnotherActivity(com.example.e_sholpine.activity.SignupChoiceActivity.class);
                    }
                });
