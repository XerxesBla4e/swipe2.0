                    ...
                    user.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful())
                            {
                                ...
                                Intent intent = new Intent(DeleteAccountActivity.this, com.example.e_sholpine.activity.HomeScreenActivity.class);
                            ...
                            {
                                Intent intent = new Intent(DeleteAccountActivity.this, com.example.e_sholpine.activity.SignInToDeleteActivity.class);
                                startActivity(intent);
                            }
                        }
                    });
