...
import com.example.e_sholpine.adapters.CommentAdapter;
import com.example.e_sholpine.helper.StaticVariable;
import com.example.e_sholpine.model.Comment;
...
//            Toast.makeText(this, "You have to sign in to comment.", Toast.LENGTH_SHORT).show();
            Intent intent1 = new Intent(CommentActivity.this, com.example.e_sholpine.activity.HomeScreenActivity.class);
