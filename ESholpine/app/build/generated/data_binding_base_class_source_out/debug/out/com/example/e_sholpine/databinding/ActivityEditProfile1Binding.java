...
public final class ActivityEditProfile1Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityEditProfile1Binding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ActivityEditProfile1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEditProfile1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_edit_profile1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEditProfile1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditProfile1Binding((LinearLayout) rootView, imbBirthdate, imbPhone,
